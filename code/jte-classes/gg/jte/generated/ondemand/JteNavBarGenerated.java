...
public final class JtenavBarGenerated {
	...
	public static void render(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, Presentation.Model.PresentationUser user, String title) {
		...
		if (user.isLoggedIn()) {
			jteOutput.writeContent("\r\n                <li class=\"nav-item\">\r\n                    <button id=\"createShopBtn\" data-bs-toggle=\"collapse\" data-bs-target=\"#createShop\" aria-expanded=\"false\" aria-controls=\"createShop\" class=\"nav-link bg-dark border-0\">\r\n                    Create Shop\r\n                    </button>\r\n                </li>\r\n                    ");
		} else {
