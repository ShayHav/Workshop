...
public class Services {
    ...
    public Response StartMarket(PaymentService payment, SupplyService supply) {
        try {
            ...
            return new Response();
        } catch (InvalidSequenceOperationsExc | IncorrectIdentification | BlankDataExc invalidSequenceOperationsExc) {
...
//    }
    ...
    public Response AppointNewShopOwner(int key, String targetUser, String userName) {
        try {
            ...
            return new Response();
        } catch (IncorrectIdentification | BlankDataExc | InvalidSequenceOperationsExc | ShopNotFoundException |
                 InvalidAuthorizationException | BidNotFoundException | CriticalInvariantException e) {
            return new Response(e.getMessage());
        }
    }
    ...
    public Response AppointNewShopManager(int key, String targetUser, String userName) {
        try {
            ...
            return new Response();
        } catch (IncorrectIdentification | BlankDataExc | ShopNotFoundException | InvalidSequenceOperationsExc |
                 InvalidAuthorizationException | BidNotFoundException | CriticalInvariantException e) {
            return new Response( e.getMessage());
        }
    }
    ...
    public Response RemoveShopManagerPermissions(int key, List<ShopManagersPermissions> shopManagersPermissionsList, String managerUser, String ownerID) {
        try {
            ...
            if (s != null)
                return new Response(s);
            return null;
        } catch (IncorrectIdentification | BlankDataExc | InvalidAuthorizationException | InvalidSequenceOperationsExc |
                 ShopNotFoundException incorrectIdentification) {
    ...
    public Response closeShop(int shopId, String userName) {
        try {
            ...
            return new Response();
        } catch (IncorrectIdentification | BlankDataExc | InvalidSequenceOperationsExc | InvalidAuthorizationException |
                 ShopNotFoundException incorrectIdentification) {
            return new Response(incorrectIdentification.getLocalizedMessage());
        }
    }
    ...
    public ResponseList<User> RequestShopOfficialsInfo(int shopName, SearchOfficialsFilter f, String userName) {
        ...
        } catch (IncorrectIdentification | ShopNotFoundException | InvalidAuthorizationException | BlankDataExc |
                 InvalidSequenceOperationsExc e) {
            return new ResponseList<>(e.getMessage());
        }
    }
    ...
    public Response DeleteUser(String admin, String username) {
        try {
            if (marketSystem.deleteUser(admin, username))
                return new Response();
        } catch (BlankDataExc | InvalidSequenceOperationsExc | IncorrectIdentification | InvalidAuthorizationException |
    ...
    public Response RemoveProductFromShopInventory(int productId, String username, int shopName) {
        ...
        }catch (InvalidAuthorizationException | IncorrectIdentification | BlankDataExc | InvalidSequenceOperationsExc |
                InvalidProductInfoException iae){
    ...
    public ResponseMap<Shop, List<Order>> getOrderHistoryForShops(String userName, Filter<Order> f, List<Integer> shopID) {
        try {
            ...
            return new ResponseMap<Shop, List<Order>>(result);
                 ...
                 InvalidSequenceOperationsExc exception) {
    ...
    public ResponseT<Product> getProduct(String username, int shopId, int serialNumber) {
        ...
        } catch (ShopNotFoundException | ProductNotFoundException | IncorrectIdentification |
                 InvalidAuthorizationException | BlankDataExc | InvalidSequenceOperationsExc e) {
            return new ResponseT<>(e.getMessage());
        }
    }
